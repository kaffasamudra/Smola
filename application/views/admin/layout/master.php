...
<head>
    ...
    <title><?= isset($title) ? $title : 'Athahira' ?></title>
    <!--     Fonts and icons     -->
    ...
    <!-- <link id="pagestyle" href="../../assets/admin/css/material-dashboard.css?v=3.2.0" rel="stylesheet" /> -->
    ...
    <style>
        ...
        a[aria-expanded="true"] .transition-arrow {
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script src="<?= base_url("assets/admin/") ?>/js/material-dashboard.min.js?v=3.2.0"></script>
    <script async defer src="https://buttons.github.io/buttons.js"></script>
    <script src="../../assets/admin/js/material-dashboard.min.js?v=3.2.0"></script>
    <script>
